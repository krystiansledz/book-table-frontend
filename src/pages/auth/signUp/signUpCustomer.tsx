...
import {
  SignUpCustomerFormDefaultValues,
  SignUpCustomerFormSchema,
...
const SignUpCustomerPage: React.FC = () => {
  ...
  } = useForm<SignUpCustomerFormValues>({
    resolver: zodResolver(SignUpCustomerFormSchema),
    defaultValues: SignUpCustomerFormDefaultValues,
  });
  const navigate = useNavigate();
  const { fireSuccessToast, fireRequestErrorToast } = useToasts();

  const onSubmit = (data: SignUpCustomerFormValues) => {
    postSignUp(data)
      .then(() => {
